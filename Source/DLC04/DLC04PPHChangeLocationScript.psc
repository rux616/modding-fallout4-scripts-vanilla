Scriptname DLC04:DLC04PPHChangeLocationScript extends Quest
...
function CheckLocation(Location targetLocation, ChangeLocationStage changeLocData, Location akOldLoc, Location akNewLoc)
	debug.trace("DLC04PPH" + (targetLocation == akNewLoc) + targetLocation.IsChild(akNewLoc))
	if (((targetLocation == akNewLoc) || targetLocation.IsChild(akNewLoc)) && changeLocData.setStageOnEnterLocation) || (targetLocation == akOldLoc && changeLocData.setStageOnEnterLocation == false)
