ScriptName DLC04:DLC04_MultiCounterQuest extends Quest
...
Function Increment(int index)
	...
	Debug.Trace("Incrementing count for index " + index + " now " + counters[index].count + "/" + counters[index].targetValue)
