...
Scriptname DLC04:Fragments:Scenes:SF_DLC04MQ02PackScene01_0101D0AE Extends Scene Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.TalkedToPack=True
if DLC04MQ02.GetStageDone(100) && DLC04MQ02.GetStageDone(400) == False
DLC04MQ02.SetStage(400)
endif
;END CODE
EndFunction
;END FRAGMENT
