...
Scriptname DLC04:Fragments:TopicInfos:TIF_DLC04GZNukaGalaxy_0101F4AF Extends TopicInfo Hidden Const

;BEGIN FRAGMENT Fragment_End
Function Fragment_End(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
DLC04GZNukaGalaxyTransmitterRef_PA04.SetValue(DLC04GZNukaGalaxySceneStage, 2)
;END CODE
EndFunction
;END FRAGMENT
