...
Scriptname DLC04:Fragments:Quests:QF_DLC04_RQ_CollarTroubleMak_01032A66 Extends Quest Hidden Const
...
kmyquest.DLC04_RQ_Manager.SetAffinityQuestStageForTarget(Alias_Target.GetActorReference(), Collared = true)
;END CODE
EndFunction
;END FRAGMENT
