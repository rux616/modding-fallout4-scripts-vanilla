Scriptname DLC04:InstanceNamingRulesManagerScript extends Quest Const
...
Event OnInit()
	...
	While (i < InstanceNameRulesMergeData.length)
		...
		Debug.TraceSelf(self, "OnInit", "RulesetSource: " + currentDatum.RulesetSource + "-> RulesetDestination: " + currentDatum.RulesetDestination)
