Scriptname DLC04:DLC04GZEMSystemTurfScript extends ObjectReference Hidden Conditional
...
Event OnCellLoad()
    ...
    if GetTriggerObjectCount() == 0 && TurfActors.Length > 0
    	...
    	;	WakeUp(TurfActors) --DO NOT WAKE the Nuka Galaxy EMS Actors.
    	endif
    endif
...
Event OnTimer(int aiTimerID)
	...
	elseif aiTimerID == IdleEncounterTimer
		...
		Bool continueTimer = FALSE;
			...
			Debug.Trace("Trigger Count: " + Self + ", " + GetTriggerObjectCount())
    		if GetTriggerObjectCount() == 0 
			Actor[] TurfActors = self.GetActorsLinkedToMe( EMSystemLinkToTurf, None )
