...
Scriptname DLC05:Fragments:Terminals:TERM_DLC05nativeWorkshopHopp_01000A58 Extends Terminal Hidden Const
...
function SetOutputTimer(float newTimer, ObjectReference terminalRef)
	...
	while i < linkedRefArray.length
		...
		if theObject is DLC05:WorkshopHopperScript
			(theObject as DLC05:WorkshopHopperScript).fFiringTimer = newTimer
		endif
		i += 1
	endWhile
