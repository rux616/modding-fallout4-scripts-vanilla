...
Scriptname DLC05:Fragments:Terminals:TERM_DLC05nativeWorkshopBuil_01000AB9 Extends Terminal Hidden Const
...
;BEGIN CODE
DLC05Init.SetRecipe(9, akterminalRef, LinkTerminalKeyword)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
DLC05Init.SetRecipe(10, akterminalRef, LinkTerminalKeyword)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
DLC05Init.SetRecipe(11, akterminalRef, LinkTerminalKeyword)
;END CODE
EndFunction
;END FRAGMENT
