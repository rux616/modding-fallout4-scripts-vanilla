...
Scriptname DLC02:Fragments:Quests:QF_DLC02WorkshopGunnerAttack_01000896 Extends Quest Hidden Const
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		DLC02WorkshopGunnerAttack01LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		DLC02WorkshopGunnerAttack01WinMessage.Show()
	endif
...
Message Property DLC02WorkshopGunnerAttack01LoseMessage Auto Const Mandatory

Message Property DLC02WorkshopGunnerAttack01WinMessage Auto Const Mandatory
