...
Scriptname DLC02:Fragments:Quests:QF_DLC02WorkshopMirelurkAtta_01000829 Extends Quest Hidden Const
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		DLC02WorkshopMirelurkAttack01LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		DLC02WorkshopMirelurkAttack01WinMessage.Show()
	endif
...
Message Property DLC02WorkshopMirelurkAttack01LoseMessage Auto Const Mandatory

Message Property DLC02WorkshopMirelurkAttack01WinMessage Auto Const Mandatory
