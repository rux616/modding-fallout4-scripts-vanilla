Scriptname DLC03:DLC03CoA_FFNucleusQuestObjScript extends Quest
...
Event Quest.OnStageSet(Quest aksender, int auiStageID, int auiItemID)
	;If this stage gets set on kickout quest, set stage to release quest objs (except pump, which the player should hang onto)
...
Event DLC03:DLC03MQ06_NukeHandlingScript.NukeCountdownStarted(DLC03:DLC03MQ06_NukeHandlingScript akSender, Var[] akArgs)
	;If the nuke countdown has started, set stage to release all quest objects from aliases
	SetStage(760)
EndEvent