ScriptName DLC03:DLC03_MultiCounterAliasColIncOnDeath extends DefaultCounterQuestRefColIncOnDeath
{When an alias in this collection dies, increments the counter(s) on the quest with the specified IDs.}
;
;The MultiCounter* scripts are a variation on the DefaultCounter* system, with a single script that manages multiple counters on the same collection.
;
...
Function Increment(ObjectReference akSenderRef)
	DLC03:DLC03_MultiCounterQuest myQuest = GetOwningQuest() as DLC03:DLC03_MultiCounterQuest
	int i = 0
