...
Scriptname DLC03:Fragments:TopicInfos:TIF_DLC03Acadia_Institute_01013F6F Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
if kmyquest.GetStageDone(22)==0
kmyquest.SetStage(22)
endif
;END CODE
EndFunction
;END FRAGMENT
