...
Scriptname DLC01:Fragments:Quests:QF_DLC01WorkshopBotRaiderAtt_0100FD1B Extends Quest Hidden Const
...
;END AUTOCAST
;BEGIN CODE
; main attacker collection has robots so always get a couple of bots
; add raiders to it
Alias_Attackers.AddRefCollection(Alias_BotRaiders)
Alias_Attackers.AddRefCollection(Alias_MoreRobots)
; clear extra collections
Alias_BotRaiders.RemoveAll()
Alias_MoreRobots.RemoveAll()

; update group size for added enemies
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.AddToGratefulFaction(Alias_SettlementSpokesman, Alias_SettlementNPCs, attackFactionValue = 7)
;END CODE
EndFunction
;END FRAGMENT
...
RefCollectionAlias Property Alias_BotRaiders Auto Const Mandatory

RefCollectionAlias Property Alias_MoreRobots Auto Const Mandatory
