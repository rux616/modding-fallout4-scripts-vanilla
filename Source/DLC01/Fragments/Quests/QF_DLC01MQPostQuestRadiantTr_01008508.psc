...
Scriptname DLC01:Fragments:Quests:QF_DLC01MQPostQuestRadiantTr_01008508 Extends Quest Hidden Const
...
kmyQuest.REParent.RandomlyEnableOrKillCollection(Alias_Raiders, 50, 0, 3)
; initialize random # of raider bots
kmyQuest.REParent.RandomlyEnableOrKillCollection(Alias_RaiderBots, 50, 0, 1)
;END CODE
EndFunction
;END FRAGMENT
...
RefCollectionAlias Property Alias_RaiderBots Auto Const Mandatory
