...
Scriptname DLC01:Fragments:Quests:QF_DLC01RETravel_VertibirdKM_01000809 Extends Quest Hidden Const
...
;BEGIN CODE
Alias_RobotTarget.GetRef().RemoveAllItems(Alias_Copilot.GetRef())
;END CODE
EndFunction
;END FRAGMENT
...
ReferenceAlias Property Alias_RobotTarget Auto Const Mandatory
