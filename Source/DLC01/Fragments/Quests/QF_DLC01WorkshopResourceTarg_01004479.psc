...
Scriptname DLC01:Fragments:Quests:QF_DLC01WorkshopResourceTarg_01004479 Extends Quest Hidden Const
...
;BEGIN CODE
; if quest complete, stop
; OR, scan was stopped
if GetStageDone(100) || GetStageDone(50)
  Stop()
endif
;END CODE
EndFunction
